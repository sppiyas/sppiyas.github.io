...
<div class="container">
  ...
  <div class="alert alert-info center-block" style="width: 50%;">
      <button type="button" class="close" data-dismiss="alert" aria-hidden="true">
          ×</button>
     <span class="glyphicon glyphicon-info-sign"></span> <strong>Well!</strong>
      <hr class="message-inner-separator">
      <h4><p>You have logged out. You can log in again. Or, Return to <a href="index.php">Home</a> </p></h4>
  </div>
