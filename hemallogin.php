...
<div class="container text-center">    
  <div class="row">
    <div class="col-sm-3 well">
      <div class="well">
        <p><a href="http://localhost/tutorialspoint/HFB/hemaldetails.php">Hemal</a></p>
        <img src="hemal.jpg" class="img-circle" height="65" width="65" alt="Avatar">
      </div>
      <div class="well">
        <p><a href="http://localhost/tutorialspoint/HFB/hemaldetails.php">Profile Details</a></p>
        <p style="text-align:center;color:green;">
            <b>Al-Anjum Hasant Hemal</b></bar></p>
      <p style="font-size:12px;">Email:Hemalpasa@gmail.com</bar>
      Mobile Number:01755334405</bar>
        </p>
      </div>
      ...
      <p><a href="https://www.facebook.com/classic.hemal?fref=gs&hc_ref=ARRvM6L1qpFNlvwqJXh3yWU6QpB3h48iUyNLzkCGzKZO5hznZMbrLB4Zp1AlxQGEPz8&dti=135021247109060&hc_location=group_dialog">Facebook</a></p>
      <p><a href="">Email</a></p>
    </div>
    <div class="col-sm-7">
      ...
      <div class="row">
        ...
        <div class="col-sm-9">
          <div class="well">
            <p><a href="http://localhost/tutorialspoint/HFB/hemalpayment.php" class="btn btn-info" role="button">Monthly Payment checking</a></p>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-sm-9">
          <div class="well">
            <p><a href="http://localhost/tutorialspoint/HFB/hemalpayment2018.php" class="btn btn-info" role="button">Monthly Payment checking</a></p>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-sm-9">
          <div class="well">
            <p><a href="http://localhost/tutorialspoint/HFB/hemalpayment2019.php" class="btn btn-info" role="button">Monthly Payment checking</a></p>
          </div>
        </div>
      </div>
      <div class="row">
