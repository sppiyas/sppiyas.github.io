...
<div class="container text-center">    
  <div class="row">
    <div class="col-sm-3 well">
      <div class="well">
        <p><a href="http://localhost/tutorialspoint/HFB/shuvodetails.php">Shuvo</a></p>
        <img src="shuvo.jpg" class="img-circle" height="65" width="65" alt="Avatar">
      </div>
      <div class="well">
        <p><a href="http://localhost/tutorialspoint/HFB/shuvodetails.php">Profile Details</a></p>
        <p style="text-align:center;color:green;">
            <b>S. M. Ashik Mahmud</b></bar></p>
      <p style="font-size:12px;">Email:@gmail.com</bar>
      Mobile Number:01710002080</bar>
        </p>
      </div>
    ...
    <div class="col-sm-7">
      ...
      <div class="row">
        ...
        <div class="col-sm-9">
          <div class="well">
            <p><a href="http://localhost/tutorialspoint/HFB/shuvopayment.php" class="btn btn-info" role="button">Monthly Payment checking</a></p>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-sm-9">
          <div class="well">
            <p><a href="http://localhost/tutorialspoint/HFB/shuvopayment2018.php" class="btn btn-info" role="button">Monthly Payment checking</a></p>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-sm-9">
          <div class="well">
            <p><a href="http://localhost/tutorialspoint/HFB/shuvopayment2019.php" class="btn btn-info" role="button">Monthly Payment checking</a></p>
          </div>
        </div>
      </div>
      <div class="row">
