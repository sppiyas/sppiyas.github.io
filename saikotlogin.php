...
<div class="container text-center">    
  <div class="row">
    <div class="col-sm-3 well">
      <div class="well">
        <p><a href="http://localhost/tutorialspoint/HFB/saikotdetails.php">Saikot</a></p>
        <img src="saikot.jpg" class="img-circle" height="65" width="65" alt="Avatar">
      </div>
      <div class="well">
        <p><a href="http://localhost/tutorialspoint/HFB/saikotdetails.php">Profile Details</a></p>
        <p style="text-align:center;color:green;">
            <b>Md. Sojibur Rahman Saikot</b></bar></p>
      <p style="font-size:12px;">Email:sojib525312@gmail.com</bar>
      Mobile Number:01738525312</bar>
        </p>
      </div>
    ...
    <div class="col-sm-7">
      ...
      <div class="row">
        ...
        <div class="col-sm-9">
          <div class="well">
            <p><a href="http://localhost/tutorialspoint/HFB/saikotpayment.php" class="btn btn-info" role="button">Monthly Payment checking</a></p>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-sm-9">
          <div class="well">
            <p><a href="http://localhost/tutorialspoint/HFB/saikotpayment2018.php" class="btn btn-info" role="button">Monthly Payment checking</a></p>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-sm-9">
          <div class="well">
            <p><a href="http://localhost/tutorialspoint/HFB/saikotpayment2019.php" class="btn btn-info" role="button">Monthly Payment checking</a></p>
          </div>
        </div>
      </div>
      <div class="row">
