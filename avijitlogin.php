...
<div class="container text-center">    
  <div class="row">
    <div class="col-sm-3 well">
      <div class="well">
        <p><a href="http://localhost/tutorialspoint/HFB/avijitdetails.php">Avijit</a></p>
        <img src="avijit.jpg" class="img-circle" height="65" width="65" alt="Avatar">
      </div>
      <div class="well">
        <p><a href="http://localhost/tutorialspoint/HFB/avijitdetails.php">Profile Details</a></p>
        <p style="text-align:center;color:green;">
            <b>Avijit Mojumder</b></bar></p>
      <p style="font-size:12px;">Email:avijitmojumder111@gmail.com</bar>
      Mobile Number:01757908979</bar>
        </p>
      </div>
      ...
      <p><a href="https://www.facebook.com/avijit.mojumder?sk=wall&fref=gm&dti=135021247109060&hc_location=group">Facebook</a></p>
      <p><a href="">Email</a></p>
    </div>
    <div class="col-sm-7">
      ...
      <div class="row">
        ...
        <div class="col-sm-9">
          <div class="well">
            <p><a href="http://localhost/tutorialspoint/HFB/avijitpayment.php" class="btn btn-info" role="button">Monthly Payment checking</a></p>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-sm-9">
          <div class="well">
            <p><a href="http://localhost/tutorialspoint/HFB/avijitpayment2018.php" class="btn btn-info" role="button">Monthly Payment checking</a></p>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-sm-9">
          <div class="well">
            <p><a href="http://localhost/tutorialspoint/HFB/avijitpayment2019.php" class="btn btn-info" role="button">Monthly Payment checking</a></p>
          </div>
        </div>
      </div>
      <div class="row">
