...
<div class="container text-center">    
  <div class="row">
    <div class="col-sm-3 well">
      <div class="well">
        <p><a href="http://localhost/tutorialspoint/HFB/raseldetails.php">Rasel</a></p>
        <img src="rasel.jpg" class="img-circle" height="65" width="65" alt="Avatar">
      </div>
      <div class="well">
        <p><a href="http://localhost/tutorialspoint/HFB/raseldetails.php">Profile Details</a></p>
        <p style="text-align:center;color:green;">
            <b>Md. Raseduzzaman Rasel</b></bar></p>
      <p style="font-size:12px;">mdrasel6845@gmail.com</bar>
      Mobile Number:01744314476</bar>
        </p>
      </div>
      ...
      <p><a href="https://www.facebook.com/raseduzzamanr?sk=wall&fref=gm&dti=135021247109060&hc_location=group">Facebook</a></p>
      <p><a href="">Email</a></p>
    </div>
    <div class="col-sm-7">
      ...
      <div class="row">
        ...
        <div class="col-sm-9">
          <div class="well">
            <p><a href="http://localhost/tutorialspoint/HFB/raselpayment.php" class="btn btn-info" role="button">Monthly Payment checking</a></p>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-sm-9">
          <div class="well">
            <p><a href="http://localhost/tutorialspoint/HFB/raselpayment2018.php" class="btn btn-info" role="button">Monthly Payment checking</a></p>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-sm-9">
          <div class="well">
            <p><a href="http://localhost/tutorialspoint/HFB/raselpayment2019.php" class="btn btn-info" role="button">Monthly Payment checking</a></p>
          </div>
        </div>
      </div>
      <div class="row">
