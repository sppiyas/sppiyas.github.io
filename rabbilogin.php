...
<div class="container text-center">    
  <div class="row">
    <div class="col-sm-3 well">
      <div class="well">
        <p><a href="http://localhost/tutorialspoint/HFB/rabbidetails.php">Rabbi</a></p>
        <img src="rabbi.jpg" class="img-circle" height="65" width="65" alt="Avatar">
      </div>
      <div class="well">
        <p><a href="http://localhost/tutorialspoint/HFB/rabbidetails.php">Profile Details</a></p>
        <p style="text-align:center;color:green;">
            <b>Asif Anwar Rabbi</b></bar></p>
      <p style="font-size:12px;">Email:asifrabbi71@gmail.com</bar>
      Mobile Number:01726267482</bar>
        </p>
      </div>
      ...
      <p><a href="https://www.facebook.com/gskasif.kholaakas?fb_dtsg_ag=Ady0xndgxx9VErdpEk9nuF_oMGN8Zu3YdsDNxxL2xeTUkg%3AAdzR7NOFTsQ_9sBNmkb6tOk4qlTUP53cdXjlCwkhCnjjvQ">Facebook</a></p>
      <p><a href="">Email</a></p>
    </div>
    <div class="col-sm-7">
      ...
      <div class="row">
        ...
        <div class="col-sm-9">
          <div class="well">
            <p><a href="http://localhost/tutorialspoint/HFB/rabbipayment.php" class="btn btn-info" role="button">Monthly Payment checking</a></p>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-sm-9">
          <div class="well">
            <p><a href="http://localhost/tutorialspoint/HFB/rabbipayment2018.php" class="btn btn-info" role="button">Monthly Payment checking</a></p>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-sm-9">
          <div class="well">
            <p><a href="http://localhost/tutorialspoint/HFB/rabbipayment2019.php" class="btn btn-info" role="button">Monthly Payment checking</a></p>
          </div>
        </div>
      </div>
      <div class="row">
